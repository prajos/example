...
@ComponentScan({ "com.loginext.ms.driver", "com.loginext.commons", "com.loginext.commons.aspect" })
@EntityScan("com.loginext.commons.entity")
@PropertySource({ "file:/data/loginext/properties/googleAPIinfo.properties",
		"file:/data/loginext/properties/application_service.properties",
...
@EnableAsync
@EnableJpaRepositories({ "com.loginext.ms.driver.repository" })
